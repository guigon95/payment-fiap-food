...
public class PaymentApi {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "5xx", description = "Internal server error",
                    content = @Content) })
    public ResponseEntity<PaymentResponse> paymentByOrderID(@PathVariable(name = "order_id") @Schema(description = "order id") Long orderID){
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "5xx", description = "Internal server error",
                    content = @Content) })
    public ResponseEntity<PaymentResponse> cancelPaymentByOrderId(@PathVariable("order_id")
                                                             @NotNull(message = "The field orderId cannot be null.") Long orderId){
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "5xx", description = "Internal server error",
                    content = @Content) })
    public ResponseEntity<PaymentResponse> cancelPayment(@PathVariable("id")
                                                         @NotNull(message = "The field id cannot be null.") Long id){
